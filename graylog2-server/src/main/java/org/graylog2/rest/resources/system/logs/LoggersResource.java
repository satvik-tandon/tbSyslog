...
@Api(value = "System/Loggers", description = "Internal tbSyslog loggers")
@Path("/system/loggers")
public class LoggersResource extends RestResource {
    ...
    private static final Map<String, Subsystem> SUBSYSTEMS = ImmutableMap.<String, Subsystem>of(
            "tbSyslog", new Subsystem("tbSyslog", ImmutableList.of("org.graylog2", "org.graylog"), "All messages from tbSyslog-owned systems."),
