...
public abstract class ServerBootstrap extends CmdLineTool {
    ...
    protected void startCommand() {
        ...
        LOG.info("tbSyslog {} {} starting up", commandName, version);
        ...
        try {
            ...
            LOG.error("tbSyslog startup failed. Exiting. Exception was:", e);
            auditEventSender.failure(AuditActor.system(nodeId), NODE_STARTUP_INITIATE, auditEventContext);
            System.exit(-1);
        }
        ...
        LOG.info("tbSyslog " + commandName + " up and running.");
