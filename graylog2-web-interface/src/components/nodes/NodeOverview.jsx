        ...
        <Row className="content">
          <Col md={12}>
            ...
            <p className="description">
              ...
              failure. The journal also helps keeping tbSyslog working if any of the outputs is too slow to keep
              up with the message rate or whenever there is a peak in incoming messages. It makes sure that
              tbSyslog does not buffer all of those messages in main memory and avoids overly long garbage
