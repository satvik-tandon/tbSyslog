...
export const HELP = {
  ...
  userNameAttribute: (
    <span>
      Which LDAP attribute to use for the username of the user in , e.g <code>uid</code>.<br />
      Try to load a test user in the sidebar section <i>User Login Test</i>, if you are unsure which attribute to use.
    </span>
  ),
  userFullNameAttribute: (
    <span>
      Which LDAP attribute to use for the full name of a synchronized tbSyslog user, e.g. <code>cn</code>.<br />
    </span>
  ),
  userUniqueIdAttribute: (
    <span>
      Which LDAP attribute to use for the ID of a synchronized tbSyslog user, e.g. <code>entryUUID</code>.<br />
    </span>
  ),
  defaultRoles: (
