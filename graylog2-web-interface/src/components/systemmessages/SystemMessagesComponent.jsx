      ...
      <Row className="content">
        <Col md={12}>
          ...
          <p className="description">
            System messages are generated by tbSyslog-server nodes on certain events that may be interesting for
            the tbSyslog administrators. You don&apos;t need to actively act upon any message in here because notifications
