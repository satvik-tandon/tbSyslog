  ...
  return (
    <>
      <Input type="checkbox"
             ...
             help="Disable the whitelist functionality. Warning: Disabling this option will allow users to enter any URL in tbSyslog entities, which may pose a security risk." />
